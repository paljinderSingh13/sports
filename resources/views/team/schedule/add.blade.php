               ...
               <form  action="{{ route('schedule.ScheduleStore') }}" method="POST">
                    ...
                    <div class="row"> 
                        <div class="mb-3 col-md-6 " >
                            ...
                            <select class="default-select form-control wide  @error('team') is-invalid @enderror" id="team_id" name="team_id" required>
                    ...
                    <!-- Tournaments Fields -->
                        <div class="mb-3 col-md-6 tournament-fields" style="display: none;">
                            ...
                            <select class="default-select form-control wide  @error('team') is-invalid @enderror" id="Team" name="opposing_team_id">
                                ...
                                @foreach($opTeams as $opteam)
                                <option value="{{$opteam->id}}" {{ old('team') == $opteam->id ? 'selected' : '' }}>{{$opteam->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <!-- Practice Fields -->
                        ...
                        <div class="mb-3 col-md-6 practice-fields" style="display: none;">
                            ...
                            <input class=" dateInput form-control @error('date_from') is-invalid @enderror" type="input" id="DateFrom" name="date_from" value="{{ old('date_from') }}">
                            @error('date_from')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3 col-md-6 practice-fields" style="display: none;">
                            ...
                            <input class="form-control @error('date_to') is-invalid @enderror" type="input" id="dateInput" name="date_to" value="{{ old('date_to') }}">
                            @error('date_to')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mt-3">
                                ...
                                <a href="{{ route('club.dashboard') }}" class="btn btn-danger ">Cancel</a>
                        </div>
                </form>
<!--end form-->            
            </div>
