                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            ...
                            <div class="text-center px-4 head_1" style="max-width:900px;">
                                ...
                                <h1 class="text-capitalize text-white mb-3 mb-md-4 wow fadeInUp" data-wow-delay="0.3s">Join The Game, Anywhere <br /> Anytime, Anyhow, Anything</h1>
                                ...
                                <a class="btn_1 wow fadeInUp" data-wow-delay="0.7s" href="join-now.php">Join Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption">
                            <div class="text-center px-4 head_1" style="max-width: 900px;">
                                ...
                                <h1 class="display-1 text-capitalize text-white mb-3 mb-md-4 wow fadeInUp" data-wow-delay="0.3s">Join The Game, Anywhere <br /> Anytime, Anyhow, Anything</h1>
                                <!-- <p class="text-white mb-4 mb-md-5 fs-5 wow fadeInUp" data-wow-delay="0.5s">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, 
                                </p> -->
                                <a class="btn_1 wow fadeInUp" data-wow-delay="0.7s" href="join-now.php">Join Now</a>
                            </div>
                        ...
                        <div class="col-12 col-lg-10">
                            <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link active" id="places-tab" data-bs-toggle="pill" data-bs-target="#places" type="button" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-map-marker-alt"></i> Places</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link" id="events-tab" data-bs-toggle="pill" data-bs-target="#events" type="button" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-golf-ball"></i> Events</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link" id="teams-tab" data-bs-toggle="pill" data-bs-target="#teams" type="button" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-users"></i> Teams</button>
                                </li>
                                <li class="nav-item" role="presentation">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-lg-20">
                        <div class="box1">
                            <div class="box1_1">
                                <img src="{{asset('front/img/icon/loyalty-program2.png')}}" />
                                <div class="box1_11">
                                    <h2>Programs</h2>
                            ...
                            <div class="box1_2">
                                <!-- <h4>International Games</h4> -->
                                <img src="{{asset('front/img/icon/004-trophy.png')}}" />
                                <!-- <h3>Wow-Games</h3> -->
                                <a href="#">Search  Now</a>
                            </div>
                        </div>
