                ...
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="club.php">Create </a></li>
                            <li><a href="club-list.php">List</a></li>
                     ...
                     <li><a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="team-create.php">Create </a></li>
                            <li><a href="team-list.php">List</a></li>
                    ...
                    <li><a href="javascript:void(0);" class="has-arrow" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="administrator-create.php">Create </a></li>
                            <!-- <li><a href="#">List</a></li> -->
